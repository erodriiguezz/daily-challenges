...
// Tests:
// 1. convertWords("hello world") should return "5 5".
// 2. convertWords("Thanks and happy coding") should return "6 3 5 6".
// 3. convertWords("The quick brown fox jumps over the lazy dog") should return "3 5 5 3 5 4 3 4 3".
